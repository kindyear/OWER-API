...
async function scrapeHeroQuickPlayRankings(playerTag, type) {
    ...
    try {
        ...
        // 定位到目标元素
        const progressBarsElement = $(`.main-content .mouseKeyboard-view.Profile-view.is-active blz-section.Profile-heroSummary .Profile-heroSummary--view.quickPlay-view.is-active .Profile-progressBars[data-category-id="${categoryId}"]`);
